...
class MediaTweetAdmin(admin.ModelAdmin):
    ...
    list_filter = [HasTrainingFilter, 'possibly_sensitive', LikesCountFilter]
...
class MediaAttachmentAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('display_media',)
    fields = (readonly_fields, 'media_url', 'parent_tweet', 'media_id', 'media_type')
    list_display = ('parent_tweet',)
